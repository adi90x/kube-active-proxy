...
#Rerun kube-gen to recreate a new nginx config file 
kube-gen --onetime --notify-cmd="nginx -s reload" --check-cmd="nginx -t " /app/nginx.tmpl /etc/nginx/conf.d/default.conf
}
